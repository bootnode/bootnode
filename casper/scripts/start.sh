...
echo "./node/target/universal/stage/bin/casperlabs-node run --server-use-gossiping --server-data-dir /.casperlabs --tls-certificate /.casperlabs/node.certificate.pem --tls-key /.casperlabs/node.key.pem -b \"casperlabs://b74021c9eb74548f03f7ef28742c439c2d67cbf9@3.16.244.129?protocol=40400&discovery=40404\" --server-host $EXTERNAL_IP"
./node/target/universal/stage/bin/casperlabs-node run --server-use-gossiping --server-data-dir /.casperlabs --tls-certificate /.casperlabs/node.certificate.pem --tls-key /.casperlabs/node.key.pem -b "casperlabs://b74021c9eb74548f03f7ef28742c439c2d67cbf9@3.16.244.129?protocol=40400&discovery=40404" --server-host $EXTERNAL_IP
